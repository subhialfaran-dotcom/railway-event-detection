...
print(f"Event distribution:/n{df['event'].value_counts()}")
...
# STEP 5: Separate features and target & Normalize the dataset
...
print(f"SVM Accuracy (80/20 split): {accuracy:.4f}")
...
print(f"80/20 Test Accuracy: {accuracy:.4f}")
